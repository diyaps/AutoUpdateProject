...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.action_01) {//使用说明
            startActivity(new Intent(this, InfoActivity.class));
        } else if (itemId == R.id.action_02) {//清除本地缓存
            clear();
        } else if (itemId == R.id.action_03) {//自定义UI
        ...
        } else if (itemId == R.id.action_04) {//获取文件MD5检验码工具
            startActivity(new Intent(this, MD5HelperActivity.class));
        } else if (itemId == R.id.action_05) {//带提示的更新
